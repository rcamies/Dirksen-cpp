...
/************************************************************/
/*   P03-F08B          Berekenen van de gewichten van 2     */
...
void main(void)                // Begin hoofdfunctie P03-F08B
{
    Kogel  kogel[2];
    int    nr;
    ...
    for (nr = 0; nr < 2; nr++)
    {
        ...
        kogel[nr].Invoer_Diameter();
        kogel[nr].Invoer_Soortgew();        // Invoer, berekening
        kogel[nr].Bereken_Gewicht();        // en uitvoer van een
        kogel[nr].Uitvoer_Gewicht();        // kogel
    };

    cout << "\n\n\nDruk op een toets: " << flush;
    getch();
}                               // Einde hoofdfunctie P03-F08B
